...
public class TestSetup extends GlobalSetup {
    ...
    public void open(WebDriver driver, String appName, String testName) { driver = eyes.open(driver, appName, testName); }
    public void open(WebDriver driver, String appName, String testName, RectangleSize rectangleSize){ driver = eyes.open(driver, appName, testName, rectangleSize); }
