...
public class ImagesReportingListener implements ITestListener {
    @Override
    ...
    public void onTestSuccess(ITestResult result) {
        ...
        if (instance instanceof ReportingTestSuite) {
            ((ReportingTestSuite) instance).setSdkName("java_images");
            ((ReportingTestSuite) instance).setGroupName("images");
