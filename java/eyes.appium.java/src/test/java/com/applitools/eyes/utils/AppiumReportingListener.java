...
public class AppiumReportingListener implements ITestListener {
    @Override
    ...
    public void onTestSuccess(ITestResult result) {
        ...
        if (instance instanceof ReportingTestSuite) {
            ((ReportingTestSuite) instance).setSdkName("java_appium");
            ((ReportingTestSuite) instance).setGroupName("appium");
