...
public class PlaywrightReportingListener implements ITestListener {
    @Override
    ...
    public void onTestSuccess(ITestResult result) {
        ...
        if (instance instanceof ReportingTestSuite) {
            ((ReportingTestSuite) instance).setSdkName("java_playwright");
            ((ReportingTestSuite) instance).setGroupName("selenium");
