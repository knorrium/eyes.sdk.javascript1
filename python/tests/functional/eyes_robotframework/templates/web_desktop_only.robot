...
Check Shadow Dom
    Eyes Open    Check Shadow Dom ${RUNNER}  batch=${BATCH_NAME}
...
Check Window with padding
    Eyes Open    Check Window with padding ${RUNNER}  batch=${BATCH_NAME}
...
Check With Ignore Region having Region ID
    Eyes Open    Check With Ignore Region having Region ID with Ignore Region ${RUNNER}  batch=${BATCH_NAME}
