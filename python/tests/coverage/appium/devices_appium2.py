...
def pixel_3_xl(app, sauce_vm, browser_name, orientation, sauce_test_name):
    ...
    return appium(options, sauce_vm, sauce_test_name, app, browser_name)
...
def iphone_xs(app, sauce_mac_vm, browser_name, orientation, sauce_test_name):
    ...
    return appium(options, sauce_mac_vm, sauce_test_name, app, browser_name)
...
def appium(options, sauce_url, sauce_test_name, app, browser_name):
