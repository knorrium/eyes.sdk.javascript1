...
namespace Applitools.Generated.Selenium.Tests
{
    ...
    {
        private static Dictionary<string, ChromiumMobileEmulationDeviceSettings> chromeSimulationData_;
        ...
        protected void initEyes(string page, ScreenOrientation deviceOrientation = ScreenOrientation.Portrait)
        {
            ...
            eyes = new Applitools.Selenium.Eyes(logHandler);
            initEyesSettings(false, false);
        ...
        private static IWebDriver InitEyesSimulation_(string deviceName, string platformVersion, ScreenOrientation deviceOrientation, string platformName)
        {
            ...
            ChromiumMobileEmulationDeviceSettings mobileSettings = chromeSimulationData_[$"{deviceName};{platformVersion};{deviceOrientation}"];
        ...
        {
            chromeSimulationData_ = new Dictionary<string, ChromiumMobileEmulationDeviceSettings>();

            #region Android
            chromeSimulationData_["Android Emulator;8.0;Portrait"] = new ChromiumMobileEmulationDeviceSettings()
            {
            ...
            chromeSimulationData_["Android Emulator;8.0;Landscape"] = new ChromiumMobileEmulationDeviceSettings()
            {
                UserAgent = "Mozilla/5.0 (Linux; Android 8.0.0; Android SDK built for x86_64 Build/OSR1.180418.004) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/69.0.3497.100 Mobile Safari/537.36",
                Width = 384,
                Height = 512,
            ...
            // [iPad Air 2, 10.3]
            chromeSimulationData_["iPad Air 2 Simulator;10.3;Landscape"] = new ChromiumMobileEmulationDeviceSettings()
            {
            ...
            chromeSimulationData_["iPad Air 2 Simulator;12.0;Landscape"] = new ChromiumMobileEmulationDeviceSettings()
            {
                UserAgent = "Mozilla/5.0 (iPad; CPU OS 11_0_1 like Mac OS X) AppleWebKit/604.2.10 (KHTML, like Gecko) Version/11.0 Mobile/15A8401 Safari/604.1",
                Width = 512,
                Height = 349,
            ...
            chromeSimulationData_["iPad Air 2 Simulator;11.3;Landscape"] = new ChromiumMobileEmulationDeviceSettings()
            {
                UserAgent = "Mozilla/5.0 (iPad; CPU OS 11_0_1 like Mac OS X) AppleWebKit/604.2.10 (KHTML, like Gecko) Version/11.0 Mobile/15A8401 Safari/604.1",
                Width = 512,
                Height = 333,
            ...
            chromeSimulationData_["iPad Pro (12.9 inch) (2nd generation) Simulator;11.0;Landscape"] = new ChromiumMobileEmulationDeviceSettings()
            {
                UserAgent = "Mozilla/5.0 (iPad; CPU OS 11_0_1 like Mac OS X) AppleWebKit/604.2.10 (KHTML, like Gecko) Version/11.0 Mobile/15A8401 Safari/604.1",
                Width = 683,
                Height = 477,
            ...
            chromeSimulationData_["iPad Pro (10.5 inch) Simulator;11.0;Landscape"] = new ChromiumMobileEmulationDeviceSettings()
            {
                UserAgent = "Mozilla/5.0 (iPad; CPU OS 11_0_1 like Mac OS X) AppleWebKit/604.2.10 (KHTML, like Gecko) Version/11.0 Mobile/15A8401 Safari/604.1",
                Width = 556,
                Height = 382,
            ...
            // [iPad Air 2, 11.3] [iPad (5th generation), 11.0]
            chromeSimulationData_["iPad (5th generation) Simulator;11.0;Portrait"] = new ChromiumMobileEmulationDeviceSettings()
            {
            ...
            // [iPad Air 2, 10.3]
            chromeSimulationData_["iPad Air 2 Simulator;10.3;Portrait"] = new ChromiumMobileEmulationDeviceSettings()
            {
                UserAgent = "Mozilla/5.0 (iPad; CPU OS 10_3 like Mac OS X) AppleWebKit/603.1.30 (KHTML, like Gecko) Version/10.0 Mobile/14E269 Safari/602.1",
                Width = 768,
                Height = 960,
            ...
            chromeSimulationData_["iPad Air 2 Simulator;11.0;Portrait"] = new ChromiumMobileEmulationDeviceSettings()
            {
                UserAgent = "Mozilla/5.0 (iPad; CPU OS 10_3 like Mac OS X) AppleWebKit/603.1.30 (KHTML, like Gecko) Version/10.0 Mobile/14E269 Safari/602.1",
                Width = 768,
                Height = 954,
            ...
            // [iPad Pro (12.9 inch) (2nd generation), 11.0] [iPad Pro (12.9 inch) (2nd generation), 12.0]
            chromeSimulationData_["iPad Pro (12.9 inch) (2nd generation) Simulator;11.0;Portrait"] = new ChromiumMobileEmulationDeviceSettings()
            {
                UserAgent = "Mozilla/5.0 (iPad; CPU OS 10_3 like Mac OS X) AppleWebKit/603.1.30 (KHTML, like Gecko) Version/10.0 Mobile/14E269 Safari/602.1",
                Width = 1024,
                Height = 1296,
            ...
            // [iPad Pro (10.5 inch), 11.0]
            chromeSimulationData_["iPad Pro (10.5 inch) Simulator;11.0;Portrait"] = new ChromiumMobileEmulationDeviceSettings()
            {
                UserAgent = "Mozilla/5.0 (iPad; CPU OS 10_3 like Mac OS X) AppleWebKit/603.1.30 (KHTML, like Gecko) Version/10.0 Mobile/14E269 Safari/602.1",
                Width = 834,
                Height = 1042,
            ...
            chromeSimulationData_["iPhone XS Simulator;12.2;Landscape"] = new ChromiumMobileEmulationDeviceSettings()
            {
            ...
            // [iPhone 11 Pro, 13.0]
            chromeSimulationData_["iPhone 11 Pro Simulator;13.0;Landscape"] = new ChromiumMobileEmulationDeviceSettings()
            {
                UserAgent = "Mozilla/5.0 (iPhone; CPU iPhone OS 13_0 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/13.0 Mobile/15E148 Safari/604.1",
                Width = 724,
                Height = 271,
            ...
            // [iPhone XS Max, 12.2]
            chromeSimulationData_["iPhone XS Max Simulator;12.2;Landscape"] = new ChromiumMobileEmulationDeviceSettings()
            {
                UserAgent = "Mozilla/5.0 (iPhone; CPU iPhone OS 13_0 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/13.0 Mobile/15E148 Safari/604.1",
                Width = 808,
                Height = 344,
            ...
            chromeSimulationData_["iPhone 11 Pro Max Simulator;13.0;Landscape"] = new ChromiumMobileEmulationDeviceSettings()
            {
                UserAgent = "Mozilla/5.0 (iPhone; CPU iPhone OS 13_0 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/13.0 Mobile/15E148 Safari/604.1",
                Width = 808,
                Height = 307,
            ...
            // [iPhone XR, 12.2]
            chromeSimulationData_["iPhone XR Simulator;12.2;Landscape"] = new ChromiumMobileEmulationDeviceSettings()
            {
                UserAgent = "Mozilla/5.0 (iPhone; CPU iPhone OS 13_0 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/13.0 Mobile/15E148 Safari/604.1",
                Width = 808,
                Height = 343,
            ...
            // [iPhone 11, 13.0]
            chromeSimulationData_["iPhone 11 Simulator;13.0;Landscape"] = new ChromiumMobileEmulationDeviceSettings()
            {
                UserAgent = "Mozilla/5.0 (iPhone; CPU iPhone OS 13_0 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/13.0 Mobile/15E148 Safari/604.1",
                Width = 808,
                Height = 310,
            ...
            // [iPhone 6 Plus, 11.0]
            chromeSimulationData_["iPhone 6 Plus Simulator;11.0;Landscape"] = new ChromiumMobileEmulationDeviceSettings()
            {
                UserAgent = "Mozilla/5.0 (iPhone; CPU iPhone OS 13_0 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/13.0 Mobile/15E148 Safari/604.1",
                Width = 736,
                Height = 364,
            ...
            // [iPhone 7, 10.3]
            chromeSimulationData_["iPhone 7 Simulator;10.3;Landscape"] = new ChromiumMobileEmulationDeviceSettings()
            {
                UserAgent = "Mozilla/5.0 (iPhone; CPU iPhone OS 13_0 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/13.0 Mobile/15E148 Safari/604.1",
                Width = 667,
                Height = 331,
            ...
            // [iPhone 7 Plus, 10.3]
            chromeSimulationData_["iPhone 7 Plus Simulator;10.3;Landscape"] = new ChromiumMobileEmulationDeviceSettings()
            {
                UserAgent = "Mozilla/5.0 (iPhone; CPU iPhone OS 13_0 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/13.0 Mobile/15E148 Safari/604.1",
                Width = 736,
                Height = 370,
            ...
            // [iPhone 5s, 10.3]
            chromeSimulationData_["iPhone 5s Simulator;10.3;Landscape"] = new ChromiumMobileEmulationDeviceSettings()
            {
                UserAgent = "Mozilla/5.0 (iPhone; CPU iPhone OS 13_0 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/13.0 Mobile/15E148 Safari/604.1",
                Width = 568,
                Height = 232,
            ...
            chromeSimulationData_["iPhone XS Simulator;12.2;Portrait"] = new ChromiumMobileEmulationDeviceSettings()
            {
                UserAgent = "Mozilla/5.0 (iPhone; CPU iPhone OS 13_0 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/13.0 Mobile/15E148 Safari/604.1",
                Width = 375,
                Height = 635,
            ...
            chromeSimulationData_["iPhone XS Max Simulator;12.2;Portrait"] = new ChromiumMobileEmulationDeviceSettings()
            {
                UserAgent = "Mozilla/5.0 (iPhone; CPU iPhone OS 13_0 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/13.0 Mobile/15E148 Safari/604.1",
                Width = 414,
                Height = 719,
            ...
            chromeSimulationData_["iPhone XR Simulator;12.2;Portrait"] = new ChromiumMobileEmulationDeviceSettings()
            {
                UserAgent = "Mozilla/5.0 (iPhone; CPU iPhone OS 13_0 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/13.0 Mobile/15E148 Safari/604.1",
                Width = 414,
                Height = 719,
            ...
            // [iPhone 6 Plus, 11.0]
            chromeSimulationData_["iPhone 6 Plus Simulator;11.0;Portrait"] = new ChromiumMobileEmulationDeviceSettings()
            {
                UserAgent = "Mozilla/5.0 (iPhone; CPU iPhone OS 13_0 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/13.0 Mobile/15E148 Safari/604.1",
                Width = 414,
                Height = 622,
            ...
            // [iPhone 7, 10.3]
            chromeSimulationData_["iPhone 7 Simulator;10.3;Portrait"] = new ChromiumMobileEmulationDeviceSettings()
            {
                UserAgent = "Mozilla/5.0 (iPhone; CPU iPhone OS 13_0 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/13.0 Mobile/15E148 Safari/604.1",
                Width = 375,
                Height = 559,
            ...
            // [iPhone 5s, 10.3]
            chromeSimulationData_["iPhone 5s Simulator;10.3;Portrait"] = new ChromiumMobileEmulationDeviceSettings()
            {
                UserAgent = "Mozilla/5.0 (iPhone; CPU iPhone OS 13_0 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/13.0 Mobile/15E148 Safari/604.1",
                Width = 320,
                Height = 460,
