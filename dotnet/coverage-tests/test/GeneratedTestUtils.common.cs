...
namespace Applitools.Generated.Utils
{
    internal partial class GeneratedTestUtils
    {
        ...
        {
            Assert.AreEqual(Convert.ToInt32(expected), actual);
        }
        ...
        public static void compareProcedure(PropertyData actual, Dictionary<string, string> expected)
        {
        ...
        public static void compareProcedure(PropertyData actual, PropertyData expected, string type = null)
        {
            Assert.AreEqual(expected.ToString(), actual.ToString());
        }

        public static void compareProcedure(Region[] actualLocation, Region[] expectedLocation, string type)
        {
            CollectionAssert.AreEquivalent(expectedLocation, actualLocation, type);
        }
    }
}