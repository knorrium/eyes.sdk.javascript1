...
- [Usage](#usage)
  - [Using Nightwatch without async/await](#using-nightwatch-without-asyncawait)
    - [BDD Style](#bdd-style)
    - [Configuration](#configuration)
  - [Using async/await](#using-asyncawait)
    - [BDD Style - Async](#bdd-style---async)
...
```js
const {Eyes, BatchInfo} = require('@applitools/eyes-nightwatch')
