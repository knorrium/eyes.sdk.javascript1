...
import {default as wdSpec, type PrimarySpecType as WDSpecType} from '@applitools/spec-driver-webdriver'
import {makeSpec, type PrimarySpecType as CustomSpecType} from './spec-driver'
