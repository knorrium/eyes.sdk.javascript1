...
export type Context = spec.Driver
export type Element = spec.Element
export type Selector = spec.Selector
export type SpecType = spec.PrimarySpecType
...
const sdk = {
  spec: spec as spec.SpecDriver,
  agentId: `eyes.testcafe/${require('../package.json').version}`,
  environment: extractEnvironment(),
}

export class Eyes extends legacy.LegacyTestCafeEyesMixin<SpecType>(eyes.Eyes) {
...
export type TestCafeCheckSettings = legacy.TestCafeCheckSettings<SpecType>
