...
describe('Coverage tests', () => {
  it('pageCoverage data is correct with vg', () => {
    ...
    cy.eyesGetAllTestResults().then(async summary => {
      ...
      assert.deepStrictEqual(info['actualAppOutput']['0']['pageCoverageInfo']['pageId'], 'my-page', 'pageId match')
      assert.deepStrictEqual(info['actualAppOutput']['0']['pageCoverageInfo']['width'], 958, 'Page width match')
      assert.deepStrictEqual(info['actualAppOutput']['0']['pageCoverageInfo']['height'], 3540, 'Page height match')
