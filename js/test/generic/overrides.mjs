export const overrides = [
  ...
  {
    // no full-page for target window by default
    'check window with default fully with vg': {config: {branchName: 'js-sdk'}},
    'check window with default fully with vg classic': {config: {branchName: 'js-sdk'}},
    'check window with default fully with scroll stitching': {config: {branchName: 'js-sdk'}},
